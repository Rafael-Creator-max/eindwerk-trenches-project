...
return [
    ...
    'base_url' => 'https://eindwerk-trenches-project-production.up.railway.app',
    ...
    'auth' => [
        ...
        // The authentication method to use. Supported: 'bearer', 'basic', 'api_key', 'openapi_guard'
        'in' => 'bearer',
        
        // Name of the auth parameter (for example, 'token' or 'api_key').
        'name' => 'token',
        
        // The value of the parameter to be used by Scribe to authenticate response calls.
        'use_value' => env('SCRIBE_AUTH_KEY'),
        
        // Placeholder for the auth token in the API documentation.
        ...
        'extra_info' => 'Log in to obtain a token, then send it as <code>Authorization: Bearer {token}</code>.',
    ],
